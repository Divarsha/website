            ...
            <div class="row">
                <div class="col-sm-4 col-md-4">
                     ...
                     <div class="form-group">
                       ...
                       <div class="form-group">
                            <input type="text"  class="form-control" name="joinas" placeholder="Join As : Volunteer/Intern" required id="joinas">
                        </div>
                       <div class="form-group">
  ...
  firebase.initializeApp(config);
	...
	<script>
        $(document).ready(function(){
           ...
           var data = {name : name,email:email,contact:contact,dob:dob,city:city,joinas:joinas,aadharcardno:aadharcardno,comments:comments};
